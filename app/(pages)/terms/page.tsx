...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: `${process.env.NEXT_PUBLIC_URL}/terms`,
	},
};
...
const Terms: React.FC = () => (
	<Paper>
		...
		<ul>
			...
			<li>
				<p>
					...
					&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Media Bubbles.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Media Bubbles, accessible from
					<Link
						href='https://mediabubbles.net'
						rel='external nofollow noopener noreferrer'
						target='_blank'
					>
						https://mediabubbles.net
					</Link>
				</p>
			</li>
			<li>
		...
		<Link rel='license' href='http://creativecommons.org/licenses/by-nc/4.0/'>
			<Image
				style={{ marginTop: '5px', marginBottom: '5px', borderWidth: 0 }}
				width={88}
				height={31}
